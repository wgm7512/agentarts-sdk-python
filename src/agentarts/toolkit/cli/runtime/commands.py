...
- start-session: Start runtime session
...
runtime_app = typer.Typer(
    name="runtime",
    help="Runtime operations (cloud only): invoke, exec-command, upload-files, download-files, start-session, stop-session",
...
runtime_app.command(name="start-session")(start_session_cmd)
